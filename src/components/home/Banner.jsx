...
const Banner = () => {
  return (
    <>
      <section id="banner" className="my-20 lg:my-32">
        <div className="container">
          <div className="flex flex-col-reverse lg:flex-row lg:justify-between">
            <div>
              <h1 className="max-w-[578px] text-3xl lg:text-7xl font-semibold font-work-sans text-primary leading-12 lg:leading-[84px] mt-[52px]">
